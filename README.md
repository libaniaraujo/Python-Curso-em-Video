# Curso de Python do Curso em Video - 100 Exercícios Resolvidos
...
##### - No Python 3 Mundo 01: foi introduzida a liguagem, apresentada seus conceitos, e ensinado a montar o primeiro programa e o uso de alguns recursos básicos.
##### - No Python 3 Mundo 02: foram apresentadas as estruturas de repetição (comandos if, else, for e while) e suas usabilidades. 
##### - No Python 3 Mundo 03: foram apresentadas as estruturas de dados (tuplas, listas, dicionários, funções, módulos e pacotes).
...
#### A seguir são descritos cada um dos exercícios.
...
- Exercício 011: Criar um programa que leia a largura e a altura de uma parede em metros, calcule a sua área e a quantidade de tinta necessária para pintá-la, sabendo que cada litro de tinta pinta uma área de 2 metros quadrados.
...
- Exercício 060: Faça um programa que leia um número qualquer e mostre o seu fatorial. Ex: 5! = 5 x 4 x 3 x 2 x 1 = 120
